...
const FounderList = ({founder}: FounderListProps) => {
    return founder.length !== 0 ?
        <div className="relative flex items-start">
            ...
            <div className={`${founder[0].name.length > 14 ? 'mb-2 sm:mb-[58px]' : 'flex items-center gap-2 mb-2 sm:mb-[89px] mt-1'} text-lg sm:text-3xl text-[#565c67]`}>
            ...
            {founder[0].logo_path ?
                <img
                    className="absolute top-[-20px] sm:top-0 right-0 w-1/4 mt-[1%]"
