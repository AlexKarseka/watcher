...
const HeaderPage = ({nameCategory}: HeaderPageProps) => {
    return (
        <div className="pt-6 px-14">
            ...
            <div className="text-2xl text-white opacity-80 capitalize">Online {nameCategory}</div>
            <div
                className="mt-2 text-[#565c67] text-xs"
            >
                The best {nameCategory} in HD quality. Watch new {nameCategory} online Watcher</div>
        </div>
    );
};
